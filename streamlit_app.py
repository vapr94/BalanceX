...
def generateParenthesis(left, right, parantheses_string, output):
    ...
    parantheses_string (str): Current string of parentheses being generated.
...
def fn_count_parantheses(matched_str, start_string):
    """
    Count the number of open and closed parentheses in the matched strings.
    ...
    Returns:
    tuple: A tuple containing the count of open and closed parentheses.
    """
...
def fn_choose_prob(temprature, count_open, count_close):
    """
    Choose a parenthesis based on temperature and the count of open and closed parentheses.

    Parameters:
    temprature (float): The temperature value as a probability between 0.0 and 1.0.
    count_open (int): Count of open parentheses.
    count_close (int): Count of closed parentheses.
