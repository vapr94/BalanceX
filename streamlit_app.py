...
I have refactored the code by improving function names, adding appropriate comments, and organizing the code structure for better readability and maintainability. Let me know if you need any further modifications.