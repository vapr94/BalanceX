...
# Function to find strings that start with a given substring in a corpus
def find_string(start_string, corpus):
    """
    Find strings that start with a given substring in a corpus.
...
def choose_prob(temperature, count_open, count_close):
    ...
    count_close (int): Number of close parentheses.
