...
I have refactored the code by improving function names, removing unnecessary comments, and optimizing the code structure for better readability and maintainability. Let me know if you need any further assistance.