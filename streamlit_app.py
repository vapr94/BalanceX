...
def chooseParenthesesProbability(temperature, count_open, count_close):
...
if st.button('Submit'):
    ...
    if len(matched_strings) > 0:
        ...
        str_drawn = chooseParenthesesProbability(temperature, count_open, count_close)
...
I have refactored the code by improving function names, removing unnecessary comments, and optimizing the code structure for better readability and maintainability. Let me know if you need any further modifications.